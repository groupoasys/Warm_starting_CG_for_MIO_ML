...
def get_solver_configuration(solver_name='cplex'):
    if solver_name == 'cplex':
        solver_configuration = {'threads': 1,
                                'mipgap': 1e-10}
    return solver_configuration


def set_solver_configuration(opt,
                             solver_configuration):
    for key in solver_configuration:
        opt.options[key] = solver_configuration[key]
...
def solve_model(model,
    ...
    solver_options = get_solver_configuration(solver_name=solver_name)
