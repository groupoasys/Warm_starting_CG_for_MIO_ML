...
#SBATCH -J 03_run_constraint_generation_UC_ptdf
...
#SBATCH --error=get_active_constraints_UC.%a.%J.err
#SBATCH --output=get_active_constraints_UC.%a.%J.out
...
time python3 03b_run_constraint_generation_UC_ptdf_parallel.py
