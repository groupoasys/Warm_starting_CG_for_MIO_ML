...
def get_statistical_analysis_UC(csv_files,
                                data_folder,
    ...
    (comparative_table_constraints,
     ...
     comparative_table_online_time) = update_CG_results_UC(CG_results=CG_results,
    ...
    for number_of_neighbors in grid_neighbours:
        ...
        (comparative_table_constraints,
         comparative_table_iterations,
         comparative_table_online_time) = update_DD_results_UC(DD_results=DD_results,
                                                               comparative_table_constraints=comparative_table_constraints,
                                                               DD_method_string='DD',
        ...
        (comparative_table_constraints,
         comparative_table_iterations,
         comparative_table_online_time) = update_DD_CG_results_UC(DD_results=DD_results,
                                                                  comparative_table_constraints=comparative_table_constraints,
                                                                  number_of_neighbors=number_of_neighbors,
                                                                  DD_method_string='DD',
                                                                  comparative_table_iterations=comparative_table_iterations,
    ...
    #                                    name_figure='boxplot_number_of_iterations_1',
...
def plot_boxplots_number_of_constraints(comparative_table_constraints,
    ...
    plt.legend(handles=legend_elements, loc='upper left', handleheight=2, prop={"size": 8})
    plt.ylabel('Number of constraints')
    plt.xlabel('Method')
    plt.savefig('UC_boxplot_number_of_constraints.pdf')
    plt.savefig('UC_boxplot_number_of_constraints.jpeg', dpi=300)
    plt.close()
    return 0
...
def plot_boxplots_number_of_iterations(comparative_table_iterations,
    ...
    bb = 500
    markersize_outliers = 3
    boxplot = plt.boxplot(comparative_table_iterations.iloc[[0], :].transpose(), positions=[0], widths=widths,
                          medianprops={"linewidth": 1.5, "solid_capstyle": "butt"},
                          flierprops={'marker': 'D', 'markersize': markersize_outliers})
    for median in boxplot['medians']:
        median.set_color('black')
    ...
    ticks_labels = ['CG']
    for index in range(1, (len(grid_neighbours) + 1)):
        boxplot = plt.boxplot(comparative_table_iterations.iloc[[4 * index - 2, 4 * index], :].transpose(),
                              positions=[(bb * index) - (0.5 * widths), (bb * index) + (0.5 * widths)],
                              patch_artist=True,
                              widths=widths,
                              medianprops={"linewidth": 1.5},
    ...
    plt.xlabel('Method')
    plt.savefig('UC_boxplot_number_of_iterations.pdf')
    plt.savefig('UC_boxplot_number_of_iterations.jpeg', dpi=300)
    plt.close()
    return 0


def plot_boxplots_number_of_iterations_2(comparative_table_iterations,
                                         grid_neighbours,
                                         original_grid_of_neighbours,
                                         name_figure='UC_boxplot_number_of_iterations',
                                         y_limits={'axis_1': [15, 25],
                                                   'axis_2': [0, 10]}):
    widths = 200
    bb = 500
    markersize_outliers = 3
...
def plot_boxplots_online_time(comparative_table_online_time,
    ...
    plt.ylabel('$\delta_t \,(\%)$')
    plt.xlabel('Method')
    plt.savefig('UC_boxplot_online_time.pdf')
    plt.savefig('UC_boxplot_online_time.jpeg', dpi=300)
    plt.close()
    return 0
