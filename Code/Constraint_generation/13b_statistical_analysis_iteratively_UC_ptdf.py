...
comparative_table_constraints_csv_name = 'UC_statistical_analysis_constraints.csv'
comparative_table_iterations_csv_name = 'UC_statistical_analysis_iterations.csv'
comparative_table_online_time_csv_name = 'UC_statistical_analysis_online_time.csv'

csv_files = {'benchmark': 'UC_coefficients_and_labels_and_more_info.csv',
             'CG': 'UC_performance_results_iteratively.csv',
