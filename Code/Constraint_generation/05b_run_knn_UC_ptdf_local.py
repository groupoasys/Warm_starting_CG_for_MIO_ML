...
for case in cases:
    ...
    dataset_file = '../Data/UC_ptdf/UC_performance_results.csv'
    end_string_name = 'new'
    ...
    dataset_file = '../Data/UC_ptdf/UC_coefficients_and_labels_and_more_info.csv'
    end_string_name = 'old'
    mp.run_knn_classification(folder_particular_dataset=folder_particular_dataset,
                              grid_neighbours=grid_neighbours,
                              dataset_file=dataset_file,
